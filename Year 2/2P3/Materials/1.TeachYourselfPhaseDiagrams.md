...
Note that the proportions of the phases only vary linearly with composition along the tie-line if the diagram has a linear weight % scale. If it has at% scale the lever rule cannot be applied
...
There is no rigorous definition as to how much spread in composition is allowed before it is not considered to be a compound any more.
...
The lower limit of a single-phase solid field formed by two falling phase boundaries intersecting in a “V” is called a eutectoid point.
