...
This shows that the pressure of gas in the ideal limit is purely entropic (the statistical drive to spread out as much as possible, electrostatic/ energetic effects ignored), which is why all gases tend to behave the same at low density.
