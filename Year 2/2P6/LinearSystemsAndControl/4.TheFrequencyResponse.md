...
Whenever you hit a zero the gradient drops by 20db/decade, and if you hit a pole it increases by the same amount.
Whenever you hit a zero the phase drops by 90 degrees, and if you hit a pole it increases by the same amount.

To find the centre of two points on a log scale you take the geometric mean instead.
