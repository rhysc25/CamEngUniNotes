...
Whenever you hit a pole the gradient drops by 20db/decade, and if you hit a zero it increases by the same amount.
Whenever you hit a pole the phase drops by 90 degrees, and if you hit a zero it increases by the same amount.
